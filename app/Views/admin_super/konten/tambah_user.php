	...
	<form method="post" action="<?php echo base_url(); ?>index.php/superadmin/simpanuser" name="soal">
		<table>
			...
			<tr>
				<td>Wilayah</td>
				<td>:</td>
				<td><select class="input" name="wilayah" onChange="javascript:ubahKode();">
						...
						?>
					</select> - <input type="text" name="nama_wil" size="10" class="input" /></td>
			</tr>
			<tr>
				<td>Kode User</td>
				<td>:</td>
				<td><input type="text" name="kode" size="10" class="input" /> - <input type="text" name="angka" size="10" class="input" /></td>
			</tr>
			<tr>
				<td>Username</td>
				<td>:</td>
				<td><input type="text" name="username" size="40" class="input" /></td>
			</tr>
			<tr>
				<td>Password</td>
				<td>:</td>
			...
			<tr>
				<td></td>
				<td></td>
				<td><input type="submit" class="input" value="Simpan" /> <input type="reset" class="input" value="Hapus" /></td>
			</tr>
		</table>
	</form>
</div>
