...
class Desa extends Controller
{
	...
	function mainkonten()
	{
		...
		$this->breadcrumb->add($nm_site4, 'kec/home/' . $id_site4 . '/' . $data['link_seo2'])->add($data['nm_site2'], 'desa/home/' . $id_site2 . '/' . $data['link_seo2'])->add(
			$data['nm_site'],
	...
	function konten()
	{
		...
		$this->breadcrumb->add($nm_site4, 'kec/home/' . $id_site4 . '/' . $link_seo4)->add($data['nm_site2'], 'desa/home/' . $id_site2 . '/' . $data['link_seo2'])->add(
			$data['nm_site'],
			'desa/mainkonten/' . $id_site2 . '/' . $id_site . '/' . $data['link_seo']
	...
	function subkonten()
	{
		...
		$data['kumpulan_konten'] = $this->Web_model->Kumpulan_Konten_Kec_Mainkonten($hal_aktif2, $hal_aktif);
		$this->breadcrumb->add($data['nm_site5'], 'kec/home/' . $id_site5 . '/' . $data['link_seo5'])->add($data['nm_site2'], 'desa/home/' . $id_site2 . '/' . $data['link_seo2'])->add($data['nm_site'], 'desa/mainkonten/' . $id_site2 . '/' . $id_site . '/' . $data['link_seo'])
	...
	function home()
	{
		...
		$this->breadcrumb->add($nm_site, 'kec/home/' . $id_site2 . '/' . $link_seo)->add($data['nm_site2'], 'desa/home/' . $id_site . '/' . $data['link_seo'])->add(
			'Beranda',
			'pages/manage/add'
		);
