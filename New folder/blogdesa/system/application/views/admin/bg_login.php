            ...
            <table width="100%">
                <tr>
                    <td width="100" colspan="3" align="center">
                        <h2><a href="<?php echo base_url(); ?>">Blog Desa Kabupaten Banyuwangi</a></h2>
                    </td>
                </tr>
                <tr>
                    <td width="100" colspan="3" align="center">
                        <h2>Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
                        </h2>
                    </td>
                </tr>
                <tr>
